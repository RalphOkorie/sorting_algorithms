...
/**
 * find_max - It function to find the maximum integer in an array
...
/**
 * arraycpy - It function to copy integers from one array to another
...
/**
 * set_array - It function sets an integer value to all indexed of
 * an array
...
/**
 * counting_sort - It implementation of counting sort algorithm
