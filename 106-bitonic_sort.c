...
#include <stdio.h>
/**
 * print_bitonic - It prints the array modified by
 * bitonic algorithm
 *
 * @arr: input array
 * @i: first index
...
/**
 * sort_up - It sorts the array in UP mode
 *
 * @arr: input array
 * @low: first index
 * @high: last index
...
/**
 * sort_down - It sorts the array in DOWN mode
 *
 * @arr: input array
 * @low: first index
 * @high: last index
...
/**
 * recursion - It recursive function that executes the bitonic sort
 * algorithm
 *
 * @arr: input array
 * @low: first index
...
/**
 * bitonic_sort - It first function that executes the bitonic_sort
 * algorithm
 *
 * @array: input array
 * @size: size of the array
