...
/**
 * m_copyarr - It copy from source to destination
...
/**
 * m_print - It prints a section of a given array
...
/**
 * merger - it function to merge the atomized elements of the array
...
/**
 * m_sort - It funtion that uses recurssion to break the array
...
/**
 * merge_sort - It implementation of merge sorting
...
void merge_sort(int *array, size_t size)
{
	...
	tem_array = (int *)malloc(sizeof(int) * size);
	...
	m_sort(array, tem_array, left, right);
